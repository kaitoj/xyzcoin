...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 38572 or testnet: 138572)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 39572 or testnet: 139572)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Xyzcoin Wiki for SSL setup instructions)") + "\n" +
